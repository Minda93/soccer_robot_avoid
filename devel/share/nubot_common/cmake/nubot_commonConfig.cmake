...
if("TRUE" STREQUAL "TRUE")
  set(nubot_common_SOURCE_PREFIX /home/minda/Minda/github/soccer_robot_avoid/src/ros_gazebo/nubot/nubot_common)
  set(nubot_common_DEVEL_PREFIX /home/minda/Minda/github/soccer_robot_avoid/devel)
  ...
  set(nubot_common_INSTALL_PREFIX /home/minda/Minda/github/soccer_robot_avoid/install)
...
if(NOT "/home/minda/Minda/github/soccer_robot_avoid/devel/include;/opt/ros/kinetic/include;/opt/ros/kinetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include;/home/minda/Minda/github/soccer_robot_avoid/src/ros_gazebo/nubot/nubot_common/core/include " STREQUAL " ")
  set(nubot_common_INCLUDE_DIRS "")
  set(_include_dirs "/home/minda/Minda/github/soccer_robot_avoid/devel/include;/opt/ros/kinetic/include;/opt/ros/kinetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include;/home/minda/Minda/github/soccer_robot_avoid/src/ros_gazebo/nubot/nubot_common/core/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "https://github.com/nubot-nudt/nubot_ws " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'nubot <nubot.nudt@gmail.com>, nubot <nubot.nudt@outlook.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'nubot_common' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'nubot_common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/minda/Minda/github/soccer_robot_avoid/src/ros_gazebo/nubot/nubot_common/${idir}'.  ${_report}")
    endif()

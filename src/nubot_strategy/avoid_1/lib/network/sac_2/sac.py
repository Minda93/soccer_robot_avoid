...
class SAC(object):
    def __init__(self,state_dim,action_dim,action_bound,logpath,train):
        ...
        """ model """
        self.actor = ActorNetwork('Actor',action_dim,action_bound,train)
        self.critic_Q1 = CriticNetwork('Q_value1',train)
        self.critic_Q2 = CriticNetwork('Q_value2',train)
        self.value_net = ValueNetwork('Value',train)
        self.target_value_net = ValueNetwork('Target_Value',train)
